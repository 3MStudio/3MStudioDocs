...
If you are reading this on an external site (e.g. Tebex), make sure to include all files from the original resource and **do not rename** internal folders. Only change the resource folder name itself if needed (e.g. `3M_Blackmarket`). 
