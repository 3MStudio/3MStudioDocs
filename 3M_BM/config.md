...
- `Framework.IsAdmin(src)` (used for admin commands)

If you need custom logic for admins or money, you can edit the bridge implementation (typically in `shared/bridge.lua` or your central framework file).
...
-- Optional advanced (if you want to override default 10 minutes):
-- Config.AutoSaveMinutes = 10
```
